Page({
    ...
    regionFullData: [
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '晋中市',
            districts: ['榆次区', '榆社县', '左权县', '和顺县', '昔阳县', '寿阳县', '太谷区', '祁县', '平遥县', '灵石县', '介休市']
          },
          {
            name: '运城市',
      ...
      },
      {
        ...
        cities: [
          {
            name: '哈尔滨市',
            districts: ['道里区', '道外区', '南岗区', '香坊区', '平房区', '松北区', '呼兰区', '阿城区', '双城区', '依兰县', '方正县', '宾县', '巴彦县', '木兰县', '通河县', '延寿县', '尚志市', '五常市']
          },
          {
            name: '齐齐哈尔市',
          ...
          {
            name: '伊春市',
            districts: ['伊美区', '乌翠区', '友好区', '嘉荫县', '汤旺县', '丰林县', '大箐山县', '南岔县', '金林区', '铁力市']
          },
          {
            name: '佳木斯市',
          ...
          {
            name: '黑河市',
            districts: ['爱辉区', '嫩江市', '逊克县', '孙吴县', '北安市', '五大连池市']
          },
          {
            name: '绥化市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '扬州市',
            districts: ['邗江区', '广陵区', '江都区', '宝应县', '仪征市', '高邮市']
          },
          {
            name: '镇江市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '芜湖市',
            districts: ['镜湖区', '弋江区', '鸠江区', '三山区', '芜湖县', '繁昌区', '南陵县', '无为市']
          },
          {
            name: '蚌埠市',
          ...
          {
            name: '安庆市',
            districts: ['迎江区', '大观区', '宜秀区', '怀宁县', '潜山市', '太湖县', '宿松县', '望江县', '岳西县', '桐城市']
          },
          {
            name: '黄山市',
          ...
          {
            name: '宣城市',
            districts: ['宣州区', '郎溪县', '广德市', '泾县', '绩溪县', '旌德县', '宁国市']
          }
        ]
      },
      {
        ...
        cities: [
          ...
          {
            name: '漳州市',
            districts: ['芗城区', '龙文区', '云霄县', '漳浦县', '诏安县', '长泰区', '东山县', '南靖县', '平和县', '华安县', '龙海市']
          },
          {
            name: '南平市',
      ...
      },
      {
        ...
        cities: [
          {
            name: '南昌市',
            districts: ['东湖区', '西湖区', '青云谱区', '湾里管理区', '青山湖区', '新建区', '南昌县', '安义县', '进贤县']
          },
          {
            name: '景德镇市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '洛阳市',
            districts: ['老城区', '西工区', '瀍河回族区', '涧西区', '吉利区', '洛龙区', '孟津区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市']
          },
          {
            name: '平顶山市',
          ...
          {
            name: '新乡市',
            districts: ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '长垣市', '卫辉市', '辉县市']
          },
          {
            name: '焦作市',
          ...
          {
            name: '周口市',
            districts: ['川汇区', '扶沟县', '西华县', '商水县', '沈丘县', '郸城县', '淮阳区', '太康县', '鹿邑县', '项城市']
          },
          {
            name: '驻马店市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '荆州市',
            districts: ['沙市区', '荆州区', '公安县', '监利市', '江陵县', '石首市', '洪湖市', '松滋市']
          },
          {
            name: '黄冈市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '邵阳市',
            districts: ['双清区', '大祥区', '北塔区', '邵东市', '新邵县', '邵阳县', '隆回县', '洞口县', '绥宁县', '新宁县', '城步苗族自治县', '武冈市']
          },
          {
            name: '岳阳市',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '楚雄彝族自治州',
            districts: ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰市']
          },
          {
            name: '红河哈尼族彝族自治州',
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '延安市',
            districts: ['宝塔区', '安塞区', '延长县', '延川县', '子长市', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县']
          },
          {
            name: '汉中市',
          ...
          {
            name: '安康市',
            districts: ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳市', '白河县']
          },
          {
            name: '商洛市',
      ...
      },
      {
        ...
        cities: [
          {
            name: '西宁市',
            districts: ['城东区', '城中区', '城西区', '城北区', '大通回族土族自治县', '湟中区', '湟源县']
          },
          {
            name: '海东市',
          ...
          {
            name: '海西蒙古族藏族自治州',
            districts: ['德令哈市', '格尔木市', '茫崖市', '乌兰县', '都兰县', '天峻县']
          }
        ]
      },
      {
      ...
      },
      {
        ...
        cities: [
          ...
          {
            name: '塔城地区',
            districts: ['塔城市', '乌苏市', '额敏县', '沙湾市', '托里县', '裕民县', '和布克赛尔蒙古自治县']
          },
          {
            name: '阿勒泰地区',
  ...
  onLoad(options) {
    ...
    if (mode === 'edit' && addressData) {
      try {
        ...
        const regionInfo = this.extractRegion(address.detail);
        ...
        // 根据解析出的地区信息更新选择器数据
        this.updateRegionDataBySelection();
   ...
   */
  initRegionData() {
    const { regionFullData } = this.data;
    
    // 初始化省份数据
    const provinces = regionFullData.map(item => ({ name: item.name }));
    
    // 初始化第一个省份的城市数据
    const cities = regionFullData[0].cities.map(item => ({ name: item.name }));
    
    // 初始化第一个城市的区县数据
    const districts = regionFullData[0].cities[0].districts.map(item => ({ name: item }));
   ...
   * 根据当前选择更新省市区数据
   */
  updateRegionDataBySelection() {
    const { regionFullData, regionIndex } = this.data;
    
    if (regionIndex[0] >= 0 && regionIndex[0] < regionFullData.length) {
      const selectedProvince = regionFullData[regionIndex[0]];
      
      // 更新城市数据
      const cities = selectedProvince.cities.map(item => ({ name: item.name }));
      
      // 更新区县数据
      let districts = [];
      if (regionIndex[1] >= 0 && regionIndex[1] < selectedProvince.cities.length) {
        const selectedCity = selectedProvince.cities[regionIndex[1]];
        districts = selectedCity.districts.map(item => ({ name: item }));
      }
  ...
  onRegionColumnChange(e) {
    ...
    if (column === 0) {
      // 省份变化，更新城市和区县
      const selectedProvince = regionFullData[value];
      const cities = selectedProvince.cities.map(item => ({ name: item.name }));
      const districts = selectedProvince.cities[0].districts.map(item => ({ name: item }));
      
      newRegionData[1] = cities;
      newRegionData[2] = districts;
      newRegionIndex[1] = 0;
      newRegionIndex[2] = 0;
      
    } else if (column === 1) {
      // 城市变化，更新区县
      const provinceIndex = newRegionIndex[0];
      const selectedCity = regionFullData[provinceIndex].cities[value];
      const districts = selectedCity.districts.map(item => ({ name: item }));
  ...
  onRegionChange(e) {
    ...
    const provinceName = regionFullData[value[0]].name;
    const cityName = regionFullData[value[0]].cities[value[1]].name;
    const districtName = regionFullData[value[0]].cities[value[1]].districts[value[2]];
    
    const fullRegion = `${provinceName}${cityName}${districtName}`;
    
    this.setData({
      regionIndex: value,
      'formData.region': fullRegion
    });
  },
  ...
  extractRegion(fullAddress) {
    ...
    // 尝试匹配省市区
    for (let i = 0; i < regionFullData.length; i++) {
      const province = regionFullData[i];
      if (fullAddress.includes(province.name.replace('省', '').replace('市', '').replace('自治区', '').replace('特别行政区', ''))) {
        for (let j = 0; j < province.cities.length; j++) {
          const city = province.cities[j];
          if (fullAddress.includes(city.name.replace('市', ''))) {
            for (let k = 0; k < city.districts.length; k++) {
              const district = city.districts[k];
              if (fullAddress.includes(district.replace('区', '').replace('县', ''))) {
                // 找到匹配的省市区，更新选择器索引
                this.setData({
                  regionIndex: [i, j, k]
                });
    ...
    // 如果都没找到，返回原始地址的前部分
    const match = fullAddress.match(/^(.{2,10}?[省市区县])/);
  ...
  extractDetailAddress(fullAddress) {
    ...
    for (let i = 0; i < regionFullData.length; i++) {
      ...
      for (let j = 0; j < province.cities.length; j++) {
        ...
        for (let k = 0; k < city.districts.length; k++) {
          const district = city.districts[k];
          const fullRegion = `${province.name}${city.name}${district}`;
          if (fullAddress.includes(fullRegion) && fullRegion.length > longestMatch.length) {
            longestMatch = fullRegion;
          }
        }
      }
    }
    ...
    // 移除匹配的地区信息，返回详细地址
    return longestMatch ? fullAddress.replace(longestMatch, '').trim() : fullAddress;
  },
